...
def _sample_tokens(config: dict[str, Any], held_out_start: int, log: Any):
    """Thin alias; the implementation moved to feature_sources so importers can share it."""
    from mech_interp_research.feature_sources import sample_tokens_note_granular

    return sample_tokens_note_granular(config, held_out_start, log)
